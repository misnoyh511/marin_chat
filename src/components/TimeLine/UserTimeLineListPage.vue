    ...
    <v-ons-list>
      <div v-for="item in $root.userTimeLineItems" :key="item.id">
        ...
        <v-ons-list-item modifier="longdivider" class="longdivider gray-btns">
          ...
          <div class="right">
            <ons-button class="triangle-btn">
              <v-ons-icon v-if="item.user_id !== $root.userId" icon="fa-exclamation-triangle" class="color-gray" @click="sendReport(item.user_id, item.id)" /> 通報
            </ons-button>
